...
import { DownloadCloud, CheckCircle2, Clock, Settings, LayoutDashboard, Folder, Lock, Calendar, Heart, Terminal } from 'lucide-react';
...
export const Sidebar: React.FC<Props> = ({ activeFilter, setActiveFilter, onOpenSettings, onOpenScheduler, onOpenPasswords, onOpenLogs }) => {
  const menuItems = [
